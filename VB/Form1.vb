...
'ORIGINAL LINE: this.simpleButton1.MouseMove += new System.Windows.Forms.MouseEventHandler(this.simpleButton1_MouseMove);
			' 
			' Form1
			' 
...
'ORIGINAL LINE: this.Load += new System.EventHandler(this.Form1_Load);
        ...
        Private _dropTargetRowHandle As Integer = -1
        Private Property DropTargetRowHandle() As Integer
            Get
                Return _dropTargetRowHandle
            End Get
